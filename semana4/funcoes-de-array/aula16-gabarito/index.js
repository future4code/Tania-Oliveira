...
function imprimirExtrato(){
    ...
    // let gastoTotal = imprimirDespesas.map((despesas, i, arr) =>{
    //     return `${despesas} ${i} ${arr}`

    // })
    // let gastoAlimentacao = imprimirDespesas.map((despesas, i, arr) =>{
    //     return `${despesas} ${i} ${arr}`

    // })
    // let gastoUtilidades = imprimirDespesas.map((despesas, i, arr) =>{
    //     return `${despesas} ${i} ${arr}`

    // })
    // let gastoViagem = imprimirDespesas.map((despesas, i, arr) =>{
    //     return `${despesas} ${i} ${arr}`
